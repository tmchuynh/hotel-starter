      ...
      <div className="relative gap-20 grid grid-cols-1 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          <div className="flex gap-4 pt-12 md:pt-0">
            <button
              onClick={handlePrev}
              className="group/button flex justify-center items-center bg-muted rounded-full w-7 h-7"
            >
              <FaChevronLeft className="w-5 h-5 transition-transform duration-300 group-hover/button:rotate-12" />
            </button>
            <button
              onClick={handleNext}
              className="group/button flex justify-center items-center bg-muted rounded-full w-7 h-7"
            >
              <FaChevronRight className="w-5 h-5 transition-transform duration-300 group-hover/button:-rotate-12" />
            </button>
          </div>
        </div>
      </div>
